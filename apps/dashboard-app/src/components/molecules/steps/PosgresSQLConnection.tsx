...
export const PosgresSQLConnection = () => {
  ...
  const validateInput = (): boolean => {
    ...
    // Ensure either sqlQuery or tableNames is provided, but not both
  ...
  return (
    <div className="flex flex-col w-full items-center p-5 min-h-screen">
      <h1 className="text-3xl font-bold mb-8">Connect to PostgreSQL</h1>
      <div className="w-full max-w-5xl p-10 flex flex-col md:flex-row gap-8 border border-blue-200 rounded-lg shadow-lg">
        <div className="w-full md:w-1/2 flex flex-col items-center text-center">
          ...
          <div className="text-3xl font-bold text-gray-800">
            <span className="text-blue-700">Posgres</span>
