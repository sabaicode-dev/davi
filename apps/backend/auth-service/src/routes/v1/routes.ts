...
export function RegisterRoutes(app: Router) {
  ...
  app.put(
    ...
    ...fetchMiddlewares<RequestHandler>(
      UpdateUserName.prototype.updateUsername
    ),

    async function UpdateUserName_updateUsername(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
  ...
  app.put(
    ...
    async function UpdateUserName_unifiedLogout(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(
      GoogleAuthController.prototype.initiateGoogleSignIn
    ),

    async function GoogleAuthController_initiateGoogleSignIn(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(GoogleAuthController),
    ...fetchMiddlewares<RequestHandler>(
      GoogleAuthController.prototype.googleCallback
    ),

    async function GoogleAuthController_googleCallback(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
  ...
  app.post(
    ...
    async function CognitoController_signUp(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
  ...
  app.post(
    ...
    async function CognitoController_signIn(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
  ...
  app.post(
    ...
    ...fetchMiddlewares<RequestHandler>(CognitoController),
    ...fetchMiddlewares<RequestHandler>(
      CognitoController.prototype.confirmSignUp
    ),

    async function CognitoController_confirmSignUp(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
  ...
  app.post(
    ...
    async function CognitoController_resendCode(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
